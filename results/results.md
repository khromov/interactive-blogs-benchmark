# interactive-blogs-benchmark — local re-run (five frameworks)

All frameworks built and measured on the **same machine, same day, same method**.
...
| iles | ✅ | iles 0.7.40 / Vite 2.9.18, Node 24 |
| astro | ✅ | astro 0.22 (Snowpack) — **Node 16** required |
...
|-----------|-------|-------|-------|-------|--------|
| astro (Preact) | islands | 12.1 / 5.4 | 12.1 / 5.4 | 12.1 / 5.4 | no |
| iles (Preact) | islands | 14.6 / 6.6 | 14.6 / 6.6 | 14.6 / 6.6 | no |
...
| iles | 74.3 / 27.4 | 191.5 / 76.8 | 582.1 / 240.5 |
| astro | 77.6 / 28.9 | 200.1 / 80.8 | 607.7 / 252.8 |
...
| Framework | post1 | post2 | post3 |
|-----------|-------|-------|-------|
| astro | 99 · 1562 · 0.000 · 0 | 95 · 2465 · 0.000 · 0 | 76 · 4162 · 0.000 · 90 |
| iles | 99 · 1699 · 0.000 · 0 | 98 · 2017 · 0.000 · 0 | 75 · 4154 · 0.000 · 126 |
...
|-----------|-----------|---------|---------|---------|
| iles | 91 | 2623 ms | 0.000 | 42 ms |
| astro | 90 | 2730 ms | 0.000 | 30 ms |
